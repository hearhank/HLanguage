...
- **K3.5 误报收敛** ✅：三源自检 0 误报（2026-08-29，k3 断言锁定）
- **K4** ✅：H 版执行引擎完成（2026-08-29，10/10 执行语料与 Rust 参考逐字节一致，cargo 门禁 10 passed；细目见 `05-k4-execution-plan.md`）
- **K5–K6** 🔴：待实现（K5 详细任务分解见 `06-k5-execution-plan.md`，策略定案见 ADR-0029）
