...
| ☑ | Rust | Zig | H | 状态 | 说明 |
|---|---|---|---|---|---|
| ☑ | `u64` | `u64` | `u64` | 已实现 | 唯一整数 |
| ☐ | `u8`/`u16`/`u32`/`u128`/`usize` | `u1..u65535` | — | 未实现 | 其他位宽整数 |
| ☐ | `i8`/`i16`/`i32`/`i64`/`i128`/`isize` | `i1..i65535` | — | 未实现 | 无有符号整数 |
| ☑ | `f64` | `f64` | `f64` | 已实现 | 唯一浮点（字面量含小数点即 f64） |
| ☐ | `f32` | `f16`/`f32`/`f80`/`f128` | — | 未实现 | 其他浮点位宽 |
| ☑ | `bool` | `bool` | `bool` | 已实现 | — |
