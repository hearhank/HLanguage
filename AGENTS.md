...
This project is indexed by GitNexus as **HLanguage** (6759 symbols, 22348 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
